...
public class TelephoneCall {
	...
	public TelephoneCall(Iterable<String> fieldNames, Iterable<String> values) {
		...
		for (String name : fieldNames) {
			...
			} else if (name.equals("job") || name.equals("marital") || name.equals("education")
					|| name.equals("default") || name.equals("housing") || name.equals("loan")
					|| name.equals("contact") || name.equals("campaign") || name.equals("previous")
					|| name.equals("poutcome")) {
